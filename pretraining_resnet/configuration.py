...
class ModelConfig(object):
    ...
    def __init__(self):
        ...
        self.train_tfrecord_list = glob.glob(os.path.join('/home/zyq/dataset/LRW/tfrecord', '*train*'))
        self.val_tfrecord_list = glob.glob(os.path.join('/home/zyq/dataset/LRW/tfrecord', '*val*'))
